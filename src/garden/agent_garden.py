...
class AgentGarden:
    def __init__(self):
        self.garden_dir = Path("data/agent_garden")
    ...
    def create_collection(self,
                         ...
                         curator: str,
                         tags: List[str]) -> Dict:
        """Create a new collection in the Agent Garden."""
    ...
    def add_agent_to_collection(self,
                              collection_id: str,
                              agent_id: str,
        ...
        self.garden["collections"][collection_id]["agents"].append(agent_entry)
        self._save_garden()
        return True
    ...
    def create_exhibit(self,
                      ...
                      start_date: str,
                      end_date: str) -> Dict:
        """Create a new exhibit in the Agent Garden."""
    ...
    def record_interaction(self,
                         ...
                         details: Dict):
        """Record an interaction with an agent in an exhibit."""
        if exhibit_id not in self.garden["exhibits"]:
            raise ValueError("Exhibit not found")
        ...
        self.garden["exhibits"][exhibit_id]["interactions"].append(interaction)
        self.garden["exhibits"][exhibit_id]["visitors"] += 1
        self._save_garden() 